...
public class QRUtil {
	 ...
	 * @return 新图片路径
	 */
	public static String addImageWater(String bgImage, String waterImg,
			String uniqueFlag) {
	...
	public static void main(String[] args) {
		...
		String qrImgPath = QRUtil.encode(content, width, height, new File(
		...
		// String waterImgPath = QRUtil.resizeImg("D:\\项目\\二维码\\git导图.png",
		// width/6, height/6, true);

		// d:/qr/qr_bg.png这种图片是自己画好边框光晕效果的边框底图
		// String tempImg = QRUtil.addWaterBorder(waterImgPath,
		// "D:\\项目\\二维码\\交易架构图.png");
